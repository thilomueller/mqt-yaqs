...
heatmap = pickle.load(open("X_measurements/100L_T1.pickle", "rb"))['heatmap']
...
heatmap = pickle.load(open("X_measurements/100L_T5.pickle", "rb"))['heatmap']
...
heatmap = pickle.load(open("X_measurements/100L_T10.pickle", "rb"))['heatmap']
