...
from bond_dimension.bond_dim_utils import generate_sim_data_supplemental
...
def run_bond_dimension_test():
    ...
    filename = f"results/bond_dim_test_supplementary/2d_ising_bond.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'results': results,
        }, f)
    ...
    filename = f"results/bond_dim_test_supplementary/heisenberg_bonds.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'results': results,
        }, f)
