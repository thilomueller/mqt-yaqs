...
axes[0, 0].text(-0.55, 0.5, "$N=10$", fontsize=12, transform=axes[0, 0].transAxes, va='center', ha='center', rotation=90)
axes[1, 0].text(-0.55, 0.5, "$N=100$", fontsize=12, transform=axes[1, 0].transAxes, va='center', ha='center', rotation=90)
axes[2, 0].text(-0.55, 0.5, "$N=1000$", fontsize=12, transform=axes[2, 0].transAxes, va='center', ha='center', rotation=90)
